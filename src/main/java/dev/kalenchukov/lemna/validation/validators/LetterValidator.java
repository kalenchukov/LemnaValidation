...
/**
 * Класс проверяющего для ограничения {@link Letter}.
 *
 * @author Aleksey Kalenchukov
 */
public final class LetterValidator extends AbstractValidator
{
	/**
	 * Конструктор для {@code LetterValidator}.
	 * @param locale локализация.
	 */
	public LetterValidator(@NotNull final Locale locale)
	{
	...
	public Violating valid(@NotNull final Field field, @Nullable final Object value)
	{
		...
		Letter constraint = field.getDeclaredAnnotation(Letter.class);
