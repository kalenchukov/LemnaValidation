...
/**
 * Класс проверяющего для ограничения {@link WeekOfMonth}.
 *
...
public final class WeekOfMonthValidator extends AbstractValidator
{
	...
	public Violating valid(@NotNull final Field field, @Nullable final Object value)
	{
		...
		WeekOfMonth constraint = field.getDeclaredAnnotation(WeekOfMonth.class);
	 ...
	 */
	private boolean isValid(@NotNull final Field field, @NotNull final WeekOfMonth constraint, @Nullable final Object value)
	{
		Objects.requireNonNull(field);
	 ...
	 */
	private boolean isValidByte(@NotNull final WeekOfMonth constraint, @NotNull final Byte value)
	{
		Objects.requireNonNull(constraint);
	 ...
	 * @return {@code true}, если значение поля корректно, иначе {@code false}.
	 */
	private boolean isValidShort(@NotNull final WeekOfMonth constraint, @NotNull final Short value)
	{
		Objects.requireNonNull(constraint);
		Objects.requireNonNull(value);
	 ...
	 * @return {@code true}, если значение поля корректно, иначе {@code false}.
	 */
	private boolean isValidInteger(@NotNull final WeekOfMonth constraint, @NotNull final Integer value)
	{
		Objects.requireNonNull(constraint);
		Objects.requireNonNull(value);
	 ...
	 * @return {@code true}, если значение поля корректно, иначе {@code false}.
	 */
	private boolean isValidLong(@NotNull final WeekOfMonth constraint, @NotNull final Long value)
	{
		Objects.requireNonNull(constraint);
		Objects.requireNonNull(value);
	 ...
	 * @return {@code true}, если значение поля корректно, иначе {@code false}.
	 */
	private boolean isValidAbstract(@NotNull final WeekOfMonth constraint, @NotNull final Long value)
	{
		Objects.requireNonNull(constraint);
		Objects.requireNonNull(value);
