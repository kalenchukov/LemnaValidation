...
/**
 * Класс проверяющего для ограничения {@link WeekOfYear}.
 *
...
public final class WeekOfYearValidator extends AbstractValidator
{
	...
	/**
	 * Конструктор для {@code WeekOfYearValidator}.
	...
	public Violating valid(@NotNull final Field field, @Nullable final Object value)
	{
		...
		WeekOfYear constraint = field.getDeclaredAnnotation(WeekOfYear.class);
	 ...
	 */
	private boolean isValid(@NotNull final Field field, @NotNull final WeekOfYear constraint, @Nullable final Object value)
	{
		Objects.requireNonNull(field);
	 ...
	 */
	private boolean isValidByte(@NotNull final WeekOfYear constraint, @NotNull final Byte value)
	{
		Objects.requireNonNull(constraint);
	 ...
	 * @return {@code true}, если значение поля корректно, иначе {@code false}.
	 */
	private boolean isValidShort(@NotNull final WeekOfYear constraint, @NotNull final Short value)
	{
		Objects.requireNonNull(constraint);
		Objects.requireNonNull(value);
	 ...
	 * @return {@code true}, если значение поля корректно, иначе {@code false}.
	 */
	private boolean isValidInteger(@NotNull final WeekOfYear constraint, @NotNull final Integer value)
	{
		Objects.requireNonNull(constraint);
		Objects.requireNonNull(value);
	 ...
	 * @return {@code true}, если значение поля корректно, иначе {@code false}.
	 */
	private boolean isValidLong(@NotNull final WeekOfYear constraint, @NotNull final Long value)
	{
		Objects.requireNonNull(constraint);
		Objects.requireNonNull(value);
	 ...
	 * @return {@code true}, если значение поля корректно, иначе {@code false}.
	 */
	private boolean isValidAbstract(@NotNull final WeekOfYear constraint, @NotNull final Long value)
	{
		Objects.requireNonNull(constraint);
		Objects.requireNonNull(value);
